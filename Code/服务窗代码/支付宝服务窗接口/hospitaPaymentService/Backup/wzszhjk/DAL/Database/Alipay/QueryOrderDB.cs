    ...
    public class QueryOrderDB : BaseDB
    {
            ...
            try
            {
                ...
                if (dr.HasRows)
                {
                    ...
                    while (dr.Read())
                    {
                        ...
                        pd.remain = !dr.IsDBNull(6) ? Convert.ToString(dr.GetInt64(6)) : "";
        ...
        public int mzOrder(AlipaymzOrderNeedInfo info, out AlipaymzReservation pd, out string msg)
        {
            ...
            try
            {
                ...
                {
                    ret = GetOrderInfo(info.patientname, info.patientidcardno, out outInfo, out msg);
                    if (ret != 0)
                    {
                        return ret;
                    }
                ...
                parameters[0].Value = info.openid + "|" + outInfo.cardno + "|" + ybcardno + "|" + info.patientname + "|" +
                    ...
                    "|2|" + scheduledate + "|2|8|" + info.orderseq + "|||ZFB||||" + info.ordertime +
                    "|" + info.orderendtime + "||";
        ...
        public int DB_CancelmzReservation(string openid, string preengageseq, out AlipaymzReservation pd, out string msg)
        {
            ...
            try
            {
                ...
                //pkg_gy_yinyijk.PRC_ZZSF_DIANZIZHCZ
                dataReader = DbHelperOra.ExeProcedureUseTran(conn, tx,
                    WebConfigParameter.QXYuYueProcedureName,
                    parameters, out result);
        ...
        private int GetOrderInfo(string name, string idcardno, out AlipaymzOrderNeedInfo info, out string msg)
        {
            int ret = 99;
            msg = "";
            ...
            try
            {
                ...
                "where idcardno = '{1}' and patientname = '{0}' ";
