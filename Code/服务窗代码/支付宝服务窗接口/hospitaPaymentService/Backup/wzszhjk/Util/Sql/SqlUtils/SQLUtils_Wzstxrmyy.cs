...
{
    public class SQLUtilsWZSTXRMYY : SQLUtils
    {
        public SQLUtilsWZSTXRMYY()
        {
     ...
     " (select count(c.brch) as zcw,g.ksmc,g.ksdm from zy_cwsz c, gy_ksdm g where c.ksdm=g.ksdm and c.jcpb=0 " +
      " group by g.ksdm,g.ksmc) b, (select count(c.brch) as sycw,g.ksdm from zy_cwsz c, gy_ksdm g where c.ksdm=g.ksdm and c.jcpb=0 and zyh is " +
            ...
            mzbrReportJC = "select a.xno as bgdh, a.checkpos || '-' || a.dep as sjmd, to_char(a.checkdate, 'yyyy-mm-dd hh24:mi:ss') as cjsj," +
            ...
            zybrReportJC = "select a.xno as bgdh, a.checkpos || '-' || a.dep as sjmd, to_char(a.checkdate, 'yyyy-mm-dd hh24:mi:ss') as cjsj," +
                           "a.doctor as sjr, to_char(a.reportdate, 'yyyy-mm-dd hh24:mi:ss') as sjsj," +
                           "a.reportdoc as jyr, '' as shr, '' as jzch, a.reportend as zdjg, '' as bbmc, a.pat_type as mzbz, '' as dyjb, '' as bz, '' as hzbh," +
            ...
            reportJCDetailByBgdh ="select a.xno as bgdh, a.checkpos || '-' || a.dep as sjmd, to_char(a.checkdate, 'yyyy-mm-dd hh24:mi:ss') as cjsj," +
                                  "a.doctor as sjr, to_char(a.reportdate, 'yyyy-mm-dd hh24:mi:ss') as sjsj," +
                                  "a.reportdoc as jyr, '' as shr, '' as jzch, a.reportend as zdjg, '' as bbmc, a.pat_type as mzbz, '' as dyjb, '' as bz, a.patid as hzbh," +
                                  "'' as sbm, b.name as brxm from patexam a, patregister b where a.patid = b.clinicno and a.check_status != '已删除' and a.xno = '{0}'";
            reportJCDetailBySbm = "select a.xno as bgdh, a.checkpos || '-' || a.dep as sjmd, to_char(a.checkdate, 'yyyy-mm-dd hh24:mi:ss') as cjsj," +
                                  "a.doctor as sjr, to_char(a.reportdate, 'yyyy-mm-dd hh24:mi:ss') as sjsj," +
                                  "a.reportdoc as jyr, '' as shr, '' as jzch, a.reportend as zdjg, '' as bbmc, a.pat_type as mzbz, '' as dyjb, '' as bz, a.patid as hzbh," +
