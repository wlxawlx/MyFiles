...
namespace HospitaPaymentService.Wzszhjk.BLL.Alipay
{
    public class AlipayPaymentLogic : BaseLogic
    {
        ...
        /// <returns></returns>
        public XmlDocument CreateOrder(string shdzid, string jzid, string qjfs, string openid, string patientname, string patientidcardno, string cardno, string patientid, string subject, double money, double tkje, string patienttype)
        {
            ...
            try
            {
                ...
                int ret = pdb.DB_CreateOrder(shdzid, jzid, qjfs, openid, patientname, patientidcardno, cardno, patientid, subject, money, tkje, patienttype, out tradeno, out error_msg);
