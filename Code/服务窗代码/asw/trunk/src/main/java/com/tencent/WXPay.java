...
public class WXPay {
     ...
     */
    // 改为静态方法直接初始化Configure的静态实例变量。 因此去掉此接口。
    // static void initSDKConfiguration(String key,String appID,String mchID,String sdbMchID,String certLocalPath,String certPassword){
    ...
    public static String requestUnifiedOrderService(UnifiedOrderReqData unifiedOrderReqData) throws Exception {
        return new UnifiedOrderService().unifiedOrder(unifiedOrderReqData);
    }
