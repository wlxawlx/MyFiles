...
public class TestsCheckHeadProtocol implements Protocol {
    ...
    public Object process(String pcode, Map<String, Object> params) throws HospitalException {
		InspectionInfo  value = HospitalInfoService.getInstance().getInspectionInfo(requiredParams(params));
		if (value!=null) {
...
//        	map=MapUtil.bean2Map2(value);
        	...
        	map.put("profiletest", value.getProfiletest());
            return map;
        } else {
            throw new HospitalException("检测台头为空");
        }
    }
