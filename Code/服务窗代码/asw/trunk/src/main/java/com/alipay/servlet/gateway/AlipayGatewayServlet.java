 ...
 * 
 * @author taixu.zqq
 * @version $Id: AlipayGatewayServlet.java, v 0.1 2014年7月22日 下午5:59:55 taixu.zqq Exp $
 */
public class AlipayGatewayServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        //支付宝响应消息  
        String responseMsg = "";
        System.out.println("AlipayGatewayServlet:doPost:start");
        //1. 解析请求参数
        Map<String, String> params = RequestUtil.getRequestParams(request);
        System.out.println("AlipayGatewayServlet:doPost:params"+params);
        ...
        try {
            ...
            try {
                ...
                //http 内容应答
                response.reset();
                response.setContentType("text/xml;charset=" + AlipayServiceEnvConstants.CHARSET);
