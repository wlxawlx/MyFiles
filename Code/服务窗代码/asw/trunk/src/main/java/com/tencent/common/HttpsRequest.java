...
public class HttpsRequest implements IServiceRequest {
    ...
    @Override
    public String sendPostJson(String url, Object jsonObj) throws UnrecoverableKeyException, KeyManagementException, NoSuchAlgorithmException, KeyStoreException, IOException {
        if (!hasInit) {
            init();
        }
        ...
        StringEntity postEntity = new StringEntity(new Gson().toJson(jsonObj), "UTF-8");
    ...
    private static class Pa {
        private String name = "zhufengxiang333";
    ...
    public static void main(String[] args) throws UnrecoverableKeyException, IOException, NoSuchAlgorithmException, KeyStoreException, KeyManagementException {
        ...
        request.sendPostJson("http://localhost:8080/post", new Pa());
