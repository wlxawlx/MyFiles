...
public class GetTestInfo {
    public Map<String, Object> getTestInfoRequest(String doctadviseno) {
        Map<String, Object> params = new HashMap<>();
        params.put("doctadviseno", doctadviseno);
        return params;
    }

    public InspectionInfo getTestInfoResponse(List<Map<String, String>> dataList) {
        ...
        for (Map<String, String> dataMap : dataList) {
            ...
            result.setReceivetime(result.getChecktime());
        }
        return result;
    }
