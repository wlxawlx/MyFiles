 ...
 * 门诊充值-订单列表0.2
 */
public class OutpatientPrepaidOrderListProtocol_V2 implements Protocol {
    @Override
    public Object process(String pcode, Map<String, Object> params) throws HospitalException {
        List<RechargeOrderHistoryInfo> values = HospitalInfoService.getInstance().getOutpatientRechargeOrdersList(requiredParams(params));
