...
namespace NipicTask
{
	...
	{
		private const string PrefixServerConfiguration = "NipicTaskServer";
        ...
        private const string DefaultServiceName = "NipicTaskServer";
        private const string DefaultServiceDisplayName = "NipicTaskServer";
		private const string DefaultServiceDescription = "昵图作业调度服务";
	    private static readonly string DefaultServerImplementationType = typeof(NipicTaskServer).AssemblyQualifiedName;
